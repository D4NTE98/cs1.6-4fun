...
#define TASKID 614
#define all 0
#define MENU "\r[4FUN] \yZmieniamy mape na cos malego?"
...
public plugin_init()
{
	register_plugin("4fun_smallmap", VERSION, "D4NTE")
	...
	////	
	pcvar_interval = register_cvar("4fun_smallmap_time", "30")
	pcvar_checknum = register_cvar("4fun_smallmap_checks", "8")
	pcvar_maxplayers = register_cvar("4fun_smallmap_players", "8")
	////	
...
public countdown()
{
	...
	show_hudmessage(0, "Drodzy gracze!^nZa %d sekund odbedzie sie glosowanie na mapa mape^nSerdecznie zapraszamy do zaglosowania", --counter)
